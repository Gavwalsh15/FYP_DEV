...
HD_PWD='C:/Users/gavwa/Desktop/Project/MicroBlaze/MicroBlaze.runs/MB_rst_clk_wiz_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_rst_clk_wiz_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_rst_clk_wiz_0_100M_0.tcl
