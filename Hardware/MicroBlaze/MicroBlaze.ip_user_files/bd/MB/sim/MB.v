...
(* CORE_GENERATION_INFO = "MB,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=MB,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=14,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=18,da_board_cnt=3,da_bram_cntlr_cnt=11,da_clkrst_cnt=17,da_mb_cnt=19,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "MB.hwdef" *) 
module MB
   (reset,
    sys_clock,
    usb_uart_rxd,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0xC0000000 32 > MB axi_bram_ctrl_0_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  MB_axi_bram_ctrl_0_1 axi_bram_ctrl_0
  ...
  MB_axi_bram_ctrl_0_bram_1 axi_bram_ctrl_0_bram
  ...
  MB_axi_uartlite_0_0 axi_uartlite_0
  ...
  MB_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(sys_clock_1),
        .clk_out1(microblaze_0_Clk),
        .locked(clk_wiz_0_locked),
        .reset(reset_1));
  MB_hello_world_writer_0_4 hello_world_writer_0
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > MB microblaze_0_local_memory/dlmb_bram_if_cntlr MB axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  MB_microblaze_0_5 microblaze_0
  ...
  microblaze_0_local_memory_imp_BO03LH microblaze_0_local_memory
  ...
  MB_rst_clk_wiz_0_100M_0 rst_clk_wiz_0_100M
       (.aux_reset_in(1'b1),
...
module microblaze_0_local_memory_imp_BO03LH
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > MB microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  MB_dlmb_bram_if_cntlr_7 dlmb_bram_if_cntlr
  ...
  MB_dlmb_v10_7 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  MB_ilmb_bram_if_cntlr_7 ilmb_bram_if_cntlr
